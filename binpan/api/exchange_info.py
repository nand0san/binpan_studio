...
def get_info_dic() -> dict:
    ...
    .. code-block::
       ...
       from binpan.api import exchange_info

       info_dic = exchange_info.get_info_dic()
...
def get_filters(symbol: str,
    ...
    .. code-block::
        ...
        filters = exchange_info.get_filters('ETHBTC')
...
def get_fees_dict(decimal_mode: bool,
    ...
    :param str symbol: Optional to request just one symbol instead of all.    :param bool decimal_mode: Fixes Decimal return type.
    :return dict: A dict with maker and taker fees.
    """
    endpoint = '/sapi/v1/asset/tradeFee'
    if symbol:
        symbol = symbol.upper()
    ret = signed_get(endpoint,
...
def get_fees(decimal_mode: bool,
    ...
    :param bool decimal_mode: Fixes Decimal return type and operative.    :param str symbol: Optional to request just one symbol instead of all.
...
def get_coins_and_networks_info(decimal_mode: bool) -> tuple:
    ...
    ret = signed_get(endpoint='/sapi/v1/capital/config/getall',
                             decimal_mode=decimal_mode)
    networks = []
    coins = []
...
def get_coins_info_list(decimal_mode: bool,
    ...
    :param bool decimal_mode: Fixes Decimal return type and operative.    :param str coin: Limit response to a coin.
    :return list: A list of dictionaries each coin.
    """

    endpoint = '/sapi/v1/capital/config/getall'
    ret = signed_get(endpoint=endpoint,
                             decimal_mode=decimal_mode)
    if not coin:
        return ret
    else:
...
def get_legal_coins(decimal_mode: bool,
    ...
    :param bool decimal_mode: Fixes Decimal return type and operative.    :param dict coins_dic: Avoid fetching the API by passing a dict with coins data.
...
def get_leveraged_symbols(decimal_mode: bool,
    ...
    :param bool decimal_mode: Fixes Decimal return type and operative.    :param dict info_dic: Avoid fetching the API by passing a dict with symbols data.
...
def exchange_status(decimal_mode: bool,
    ...
    :param bool decimal_mode: Fixes Decimal return type and operative.    :param bool tradeable: Require or not just currently trading symbols.
...
def get_top_gainers(decimal_mode: bool,
    ...
    .. code-block::
        ...
        get_top_gainers(decimal_mode=False)
