...
from .auth import signed_get, signed_post
from ..core.time_helper import convert_milliseconds_to_str, convert_string_to_milliseconds
...
def daily_account_snapshot(account_type: str,
    ...
    :param bool decimal_mode: Fixes Decimal return type and operative.    :param int limit: Days limit. Default 30.
    ...
    ret = signed_get(endpoint='/sapi/v1/accountSnapshot',
...
def get_fills_price(original_order_dict: dict,
    ...
    :param bool decimal_mode: Fixes Decimal return type and operative.    :return float: Price averaged.
...
def get_fills_qty(original_order_dict: dict,
    ...
    :param dict original_order_dict: A putting order response from API dict.    :param bool margin: Checks if margin or not.
...
def get_spot_trades_list(symbol: str,
    ...
    :param bool decimal_mode: Fixes Decimal return type and operative.    :param int limit: Default 500; max 1000.
    ...
    return signed_get(endpoint=endpoint,
                              params={'limit': limit,
                                      'symbol': symbol,
                                      'orderId': orderId,
                                      'startTime': startTime,
...
def get_margin_trades_list(symbol: str,
    ...
    :param str symbol: Symbol's trades.
    :param bool decimal_mode: Fixes Decimal return type and operative.    :param bool isIsolated: Sets for getting isolated or not isolated trades. Default is false.
...
def get_spot_account_info(decimal_mode: bool,
    ...
    :param bool decimal_mode: Fixes Decimal return type and operative.    :param int recvWindow: The value cannot be greater than 60000
...
def get_spot_free_balances(decimal_mode: bool,
    ...
    :param bool decimal_mode: Fixes Decimal return type and operative.    :return dict: Free balances.
    """
    ret = {}
    if not data_dic:
...
def get_spot_locked_balances(decimal_mode: bool,
    ...
    :param bool decimal_mode: Fixes Decimal return type and operative.    :param dict data_dic: If available, account info can be passed as data_dic parameter to avoid API calling.
...
def get_coins_with_balance(decimal_mode: bool) -> list:
    ...
    :param bool decimal_mode: Fixes Decimal return type and operative.    :return list:
    """
    data_dic = get_spot_account_info(decimal_mode=decimal_mode)
...
def get_spot_balances_df(decimal_mode: bool,
    ...
    :param bool decimal_mode: Fixes Decimal return type and operative.    :param bool filter_empty: Discards empty quantities.
...
def get_spot_balances_total_value(decimal_mode: bool,
    ...
    :param bool decimal_mode: Fixes Decimal return type and operative.    :param pd.DataFrame balances_df: A BinPan balances dataframe.
...
def get_margin_account_details(decimal_mode: bool) -> dict:
    ...
    ret = signed_get(endpoint=margin_endpoint,
                             params={},
                             decimal_mode=decimal_mode)
    return ret
...
def get_margin_balances(decimal_mode: bool) -> dict:
    ...
    :param bool decimal_mode: Fixes Decimal return type and operative.    :return dict: A dictionary with coins with balances.
...
def get_margin_free_balances(decimal_mode: bool,
    ...
    :param dict balances: Returns dict with assets as keys and a float value for not null quantities.    :param bool decimal_mode: Fixes Decimal return type.
...
def get_margin_locked_balances(decimal_mode: bool,
    ...
    :param bool decimal_mode: Fixes Decimal return type.    :param dict balances: Returns dict with assets as keys and a float value for not null quantities.
    :return dict: A dict with float values.
...
def get_margin_balances_total_value(decimal_mode: bool,
    ...
    :param dict balances: A BinPan balances dict. It is optional to avoid an API call.    :param str convert_to: A Binance coin.
