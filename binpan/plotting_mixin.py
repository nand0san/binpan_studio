"""
Plotting mixin for Symbol class.
"""
...
from handlers.indicators import zoom_cloud_indicators, market_profile_from_klines_melt
...
class PlottingMixin:
    """Mixin that adds plotting methods to Symbol."""
