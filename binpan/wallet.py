...
from .api.market import convert_coin
from .api.wallet_api import get_spot_balances_df, daily_account_snapshot, get_margin_balances, convert_str_date_to_ms
...
class Wallet(object):
    ...
    def update_margin(self, decimal_mode=False):
        ...
        :return dict: Wallet dictionary
        """
        my_margin = get_margin_balances(decimal_mode=decimal_mode)
