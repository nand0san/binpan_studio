...
from ..storage.files import get_encoded_telegram_secrets
from .logs import LogManager
from .time_helper import convert_milliseconds_to_str
from ..api.wallet_api import get_spot_balances_df, get_spot_balances_total_value
...
def telegram_bot_send_text(msg: dict | str,
    ...
    .. code-block:: python
        ...
        binpan.storage.files.add_any_key(key="xxxxxxxxxx", key_name="encoded_telegram_bot_id")

        # write to your bot and then get your chat id from https://api.telegram.org/bot<YourBOTToken>/getUpdates
        binpan.storage.files.add_any_key(key="xxxxxxxxxx", key_name="encoded_chat_id")
