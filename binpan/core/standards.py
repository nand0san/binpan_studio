...
binance_api_trades_cols_order = [trade_trade_id_col, trade_price_col, trade_quantity_col, trade_quote_quantity_col,
                                 trade_date_col, trade_timestamp_col, trade_buyer_was_maker_col, trade_best_price_match_col]

postgresql_trades_cols_order = [trade_trade_id_col, trade_price_col, trade_quantity_col, trade_quote_quantity_col,
                                trade_buyer_order_id_col, trade_seller_order_id_col, trade_date_col, trade_timestamp_col,
...
postgresql_agg_trade_cols_order = [agg_trade_id_col,
                                   agg_trade_price_col,
                                   agg_quantity_col,
...
binance_api_agg_trade_cols_order = [agg_trade_id_col, agg_trade_price_col, agg_quantity_col, agg_first_trade_id_col,
...
binpan_type_columns_dict = {'kline': binance_api_candles_cols,
                            'trade': binance_api_trades_cols_order,
                            'aggTrade': binance_api_agg_trade_cols_order,
                            'aggtrade': binance_api_agg_trade_cols_order}
...
agg_trades_api_map_columns = {'M': trade_best_price_match_col, 'm': trade_buyer_was_maker_col, 'T': trade_timestamp_col,
                              'l': trade_last_trade_id, 'f': trade_first_trade_id, 'q': trade_quantity_col, 'p': trade_price_col,
...
atomic_trades_api_map_columns = {'id': trade_trade_id_col, 'price': trade_price_col, 'qty': trade_quantity_col,
                                 'quoteQty': trade_quote_quantity_col, 'time': trade_timestamp_col,
                                 'isBuyerMaker': trade_buyer_was_maker_col, 'isBestMatch': trade_best_price_match_col}
...
# market things
klines_api_map_columns = {"t": kline_open_time_col, "o": kline_open_col, "h": kline_high_col, "l": kline_low_col, "c": kline_close_col,
                          "v": kline_volume_col, "T": kline_close_time_col, "q": kline_quote_volume_col, "n": kline_trades_col,
                          "V": kline_taker_buy_base_volume_col, "Q": kline_taker_buy_quote_volume_col, "B": kline_ignore_col}

trades_api_map_columns = {'M': trade_best_price_match_col, 'm': trade_buyer_was_maker_col, 'T': trade_timestamp_col,
                          'l': trade_last_trade_id, 'f': trade_first_trade_id, 'q': trade_quantity_col, 'p': trade_price_col,
                          'a': trade_agg_trade_id_col}
...
agg_trades_columns_from_binance = [trade_agg_trade_id_col, trade_price_col, trade_quantity_col, trade_first_trade_id,
                                   trade_last_trade_id, trade_date_col, trade_timestamp_col, trade_buyer_was_maker_col,
...
#                                  'Buyer was maker', 'Best price match']
agg_trades_columns_from_redis = [trade_agg_trade_id_col, trade_price_col, trade_quantity_col, trade_first_trade_id, trade_last_trade_id,
                                 trade_date_col, trade_timestamp_col, trade_buyer_was_maker_col, trade_best_price_match_col]
# atomic_trades_columns_from_binance = ['Trade Id', 'Price', 'Quantity', 'Quote quantity', 'Date', 'Timestamp', 'Buyer was maker',
#                                       'Best price match']
atomic_trades_columns_from_binance = [trade_trade_id_col, trade_price_col, trade_quantity_col, trade_quote_quantity_col, trade_date_col,
                                      trade_timestamp_col, trade_buyer_was_maker_col, trade_best_price_match_col]
# atomic_trades_columns_from_redis = ['Trade Id', 'Price', 'Quantity', 'Buyer Order Id', 'Seller Order Id', 'Date', 'Timestamp',
#                                     'Buyer was maker', 'Best price match']
atomic_trades_columns_from_redis = [trade_trade_id_col, trade_price_col, trade_quantity_col, trade_buyer_order_id_col,
...
postgresql2binpan_map_dict = {"kline": {"time": kline_open_time_col,
                                        "open": kline_open_col,
                                        "high": kline_high_col,
                                        "low": kline_low_col,
