...
from ..core.time_helper import infer_frequency_and_set_index
...
def candles_ta(data: pd.DataFrame,
    ...
    Plot example:
        ...
        .. code-block:: python
            ...
            binpan.plotting.charts.candles_ta(data=ethbtc.df,
     ...
     Used just if actions column passed.
        ...
        Example:
            ...
            .. code-block:: python
                ...
                import binpan
                from ..analysis.strategies import random_strategy
                ...
                df = binpan.analysis.strategies.random_strategy(data=bt.df, buys_qty=10, sells_qty=12)
                ...
                binpan.plotting.charts.candles_tagged(data=df,
                                                        plot_volume=False,
    ...
    Example:
        .. code-block:: python
           ...
           lunc = binpan.Symbol(symbol='luncbusd',
                                ...
                                closed = True)
           lunc.get_agg_trades()
           binpan.plotting.charts.plot_trade_size(data = lunc.trades, logarithmic=True)
...
def plot_pie(serie: pd.Series, categories: int = 15, title=f"Size trade categories", logarithmic=False):
    ...
    Example:
        ...
        .. code-block:: python
           ...
           binpan.plotting.charts.plot_pie(serie = lunc.trades['Quantity'], logarithmic=True)
...
def plot_scatter(df: pd.DataFrame, x_col: str, y_col: str, symbol: str = None, color: str = None, marginal: bool = True, title: str = None,
    ...
    .. code-block::
       ...
       binpan.plotting.charts.plot_scatter(df = lunc.df,
                                             x_col='Close',
                                             y_col='Volume',
                                             color='Trades',
                                             symbol='Close',
...
def plot_hists_vs(x0: pd.Series, x1: pd.Series, x0_name: str = None, x1_name: str = None, bins: int = 50, hist_funct: str = 'sum',
    ...
    .. code-block::
       ...
       binpan.plotting.charts.plot_hists_vs(x0=lunc.df['High'],
                                              x1=lunc.df['Low'],
                                              bins=50,
                                              hist_funct='count',
