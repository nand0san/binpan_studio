...
from .core.time_helper import (get_dataframe_time_index_ranges, remove_initial_included_ranges,
...
class SymbolIndicators:
    ...
    def sma(self, window: int = 21, column: str = 'Close', inplace=True, suffix: str = '', color: str | int = None, **kwargs) -> pd.Series:
        ...
        :param str or int color: Color to show when charts. It can be any color from plotly library or a number in the list of those.
    ...
    def ema(self, window: int = 21, column: str = 'Close', inplace=True, suffix: str = '', color: str | int = None, **kwargs) -> pd.Series:
        ...
        :param bool inplace: Make it permanent in the instance or not.
        :param str suffix: A decorative suffix for the name of the column created.
        :param str or int color: Color to show when charts. It can be any color from plotly library or index number in that list.
            <https://community.plotly.com/t/plotly-colours-list/11730>
    ...
    def macd(self, fast: int = 12, slow: int = 26, smooth: int = 9, inplace: bool = True, suffix: str = '', colors: list = None, **kwargs) -> pd.DataFrame:
        ...
        :param bool inplace: Make it permanent in the instance or not.
        :param str suffix: A decorative suffix for the name of the column created.
        :param list colors: A list of colors for the MACD dataframe columns. Is the color to show when charts.
    ...
    def rsi(self, length: int = 14, inplace: bool = True, suffix: str = '', color: str | int = None) -> pd.Series:
        ...
        # if self.is_numba:
        from .analysis.numba_tools import rsi_numba
    ...
    def stoch_rsi(self, rsi_length: int = 14, k_smooth: int = 3, d_smooth: int = 3, inplace: bool = True, suffix: str = '',
        ...
        :param bool inplace: Make it permanent in the instance or not.
        :param str suffix: A decorative suffix for the name of the column created.
        :param list colors: Is the color to show when charts.
    ...
    def on_balance_volume(self, inplace: bool = True, suffix: str = '', color: str | int = None, **kwargs) -> pd.Series:
        ...
        :param bool inplace: Make it permanent in the instance or not.
        :param str suffix: A decorative suffix for the name of the column created.
        :param str or int color: Is the color to show when charts.
    ...
    def alternating_fractal(self, max_period: int = None, inplace: bool = True, overlap_plot=True, with_trend: bool = True,
        ...
        :param str suffix: A decorative suffix for the name of the column created.
        :param list colors: A list of colors for the indicator dataframe columns. Is the color to show when charts. It can be any color
